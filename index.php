...
<title>Project Worlds || EXAM PORTAL </title>
...
<?php if(@$_GET['q7']) { echo '<p style="color:red;font-size:15px;">'.@$_GET['q7'].'</p>'; } ?>
<!-- Submit button -->
<div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          <div class="row">
            <div class="col-md-4">
              <img src="image.jpg" width=100 height=100 alt="dev" class="img-rounded">
            </div>
            <div class="col-md-5">
              <a href="#" style="color:#202020; font-family:'typo'; font-size:18px" title="Find on Facebook">Developer Name</a>
              <h4 style="font-family:'typo' ">+91 1234567890</h4>
              <h4 style="font-family:'typo' ">email@domain.com</h4>
              <h4 style="font-family:'typo' ">Some University</h4>
            </div>
          </div>
        </p>
      </div>
