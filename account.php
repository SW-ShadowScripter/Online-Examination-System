<!-- online-examination-systen-in-php\account.php -->
 just strore file and path
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          <div class="row">
            <div class="col-md-4">
              <img src="" width=100 height=100 alt="Alex Johnson" class="img-rounded">
            </div>
            <div class="col-md-5">
              <h4 style="color:#202020; font-family:'typo'; font-size:16px" class="title1">+1 555-123-4567</h4>
              <h4 style="font-family:'typo'">alex.johnson@example.com</h4>
              <h4 style="font-family:'typo'"> University</h4>
            </div>
          </div>
        </p>
      </div>
